...
class KtjniWriterTest {
  ...
  @Test fun `writePrologue - generates correct header format`() {
  ...
  @Test fun `writeEpilogue - generates correct footer format`() {
    val stringWriter = StringWriter()
    PrintWriter(stringWriter).use { out ->
      out.writeEpilogue()
    }
  ...
  @Test fun `writeNativeMethods - handles non-overloaded methods correctly`() {
  ...
  @Test fun `writeNativeMethods - handles overloaded methods correctly`() {
    val nativeMethods = listOf(
  ...
  @Test fun `writeStatics - generates correct constant definitions`() {
